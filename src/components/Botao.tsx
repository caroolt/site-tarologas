...
interface BotaoProps {
  variant?: 'primario' | 'secundario' | 'variante3';
...
export default function Botao({ 
  ...
  const baseClasses = "font-worksans font-semibold text-2xl px-12 py-3 rounded-lg transition-all duration-200 flex items-center justify-center min-h-[60px]";
